const questions = [
    ...
    {
        question: "What insignia do enlisted cadet wear of the grey baret?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            {text: "Private first class", correct: false},
            {text: "Three disc", correct: false},
            {text: "Comand sergant major", correct: false},
            {text:  "Corporal", correct: true}, 
        ]
    },
    {
        question: "How often must a uniform be worn by cadet?",
        answers: [
    ...
    {
        question: "What size/color earing can femal cadet wear in uniforms ?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            {text: "AR 670-1 and CCR 145-2", correct: true},
    ...
    },
    {
        ...
        answers: [
            {text: "brown Socks", correct: false},
            {text: "pink Socks", correct: false},
            {text: "purple Socks", correct: false},
            {text:  "Black Socks", correct: true}, 
        ]
    }
...
function showQuestion(){
    ...
    questionElemnt.innerHTML = questionNo + ". " + currentQuestion.
    question;
